...
public enum ModArmorMaterials implements ArmorMaterial {
    ENDERITE("enderite", 41, new int[]{4, 7, 9, 4}, 18,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.5f, 0.2f, () -> Ingredient.ofItems(ModItems.ENDERITE_INGOT)),

    COPPER("copper", 7, new int[]{2, 5, 6, 2}, 9,
